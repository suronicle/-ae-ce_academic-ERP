            ...
            <div class="card">
               ...
               <div class="card-body table-responsive p-0" style="height: 500px;">
                  <table class="table table-head-fixed text-nowrap">
                     ...
                     <tbody>
                        <c:forEach var="boardN" items="${boardN}">
                           <tr>
                              <td><a
                                 href="/mBoardDetail?boardNum=${boardN.boardNum}&userId=${user.userId}">${boardN.boardNum }</a></td>
                              <td>${boardN.boardTitle}</td>
                              <td>${boardN.boardUserId}</td>
                              <td>${boardN.pName}</td>
                              <td>${boardN.boardDate}</td>
                              <td>${boardN.boardCount}</td>
                           </tr>
                        </c:forEach>
                     </tbody>
                  </table>
