				...
				<div class="card">
					...
					<div class="card-body table-responsive p-0" style="height: 500px;">
						<table class="table table-head-fixed text-nowrap">
							...
							<tbody>
								<c:forEach var="board" items="${boardN}">
								<tr>
									<td><a href="/project/boardDetail?boardNum=${board.boardNum }&userId=${param.userId}">${board.boardNum }</a></td>
					...
					<div class="card-footer" style="background-color: #FFFFFF;">
						...
						<c:if test="${user.pId.equals('003') }">
							<button type="submit" class="btn btn-primary"
								onclick="location.href='/project/boardRegister?userId=${param.userId}'">
