          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a
										href="/project/mMain?userId=${mail.sendId }">Home</a></li>
  ...
  <!-- Main content -->
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
   <a href="/project/mailSend?userId=${mail.sendId}" class="btn btn-primary btn-block mb-3">메일 보내기</a>
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                ...
                <li class="nav-item active">
                  <a href="/project/mMail?userId=${mail.sendId}" class="nav-link">
                    <i class="fas fa-inbox"></i> 수신함
                    <span class="badge bg-primary float-right">${mailCount }</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="/project/mSend?userId=${mail.sendId}" class="nav-link">
                  ...
                  <li class="nav-item">
                 <a  href="/project/mMailDel?userId=${mail.sendId}" class="nav-link">
          ...
          <div class="col-md-9">
            <div class="card card-primary card-outline">
              ...
              <div class="mailbox-read-info">
                ...
                <h6>To : ${info.userEmail }
                <input type="hidden" value="${mail.sendId }">
              ...
              <div class="card-footer">
                ...
                <button type="reset" class="btn btn-default" onclick="location.href='/project/mSend?userId=${mail.sendId}'"><i class="fas fa-times"></i> 뒤로가기</button>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
