								...
								<div class="card-body" style="height: 700px;">
									<form action="/sInforRegister" method="post">
										...
										<table class="table table-bordered">
											...
											<tbody>
												<c:forEach var="student" items="${sInforRegister }">
									...
									<form action="/sInforRegister" method="post">
										...
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<div class="form-group">
													<label>강사 전화번호</label> <input type="text" name = "userPhone"
														class="form-control" readonly>
												</div>
											</div>
											<div class="col-sm-12">
											<div class="form-group">
													<label>강의 내용</label> <textarea class="form-control" style = "height: 390px;"
														readOnly></textarea>
											</div>
											</div>
										</div>
										<div class="col-7">
											<button style="display: inline-block; float: right;" type="submit"
												class="btn btn-primary" disabled="disabled">신청하기</button>
										</div>
									</form>
								</div>
								<!-- /.col -->
