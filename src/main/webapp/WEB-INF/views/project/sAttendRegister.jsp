											...
											<form
													...
													<div class="col-sm-6">
														...
														<div class="form-group">
															<label>승인 여부</label> <input type="text"
																class="form-control" value="${dto.pName }" readonly>

														</div>
														<div class="form-group">
															<label>근태 구분</label> <input type="text"
																value="${dto.aName }" class="form-control" readOnly>

														</div>
														<div class="form-group">
															<label>기간</label> <input type="text" class="form-control"
																value="${param.aDate }" readOnly>
														</div>
													</div>
												...
												<div class="col-6">
													<button type="submit" class="btn btn-warning"
														name="savebtn"
														style="display: inline-block; float: right;">Save</button>
												</div>
											</form>
										</div>
										<!-- /.col -->
							...
							<div class="col-12">
								<div class="card card-secondary">
									<div class="card-header">
										...
										<form action="/project/sAttendRegister" method="get">
											<input type="hidden" name="userId" value="${param.userId }">
											<input type="hidden" name="aDate" value="${param.aDate }">
									...
									<div class="card-body table-responsive p-0"
										...
										<table class="table table-head-fixed text-nowrap">
											...
											<tbody>
												<c:forEach var="student" items="${sAttendRegisterForm }">
													<tr>
														<td>${student.aLecNum }</td>
														<td>${student.lectureName }</td>
														<td><c:if test="${student.aConfirm == 100 }">
																<c:if test="${param.aNum == null || param.aNum == 500}">
																	<a
																		href="/project/sAttendRegister?userId=${student.aId }&aDate=${student.aDate}">
																		${student.aName }</a>
																</c:if>
																<c:if
																	test="${param.aNum == 0 || param.aNum == 2 ||param.aNum == 3 ||param.aNum == 6 }">
																	<a
																		href="/project/sAttendRegister?userId=${student.aId }&aDate=${student.aDate}&aNum=${student.aNum}">
																		${student.aName }</a>
																</c:if>
                                                ...
                                                자료 없음
																...
																test="${not empty student.realFileName}">
