            ...
            <div class="card">
               ...
               <div class="card-body table-responsive p-0" style="height: 500px;">
                  <table class="table table-head-fixed text-nowrap">
                     ...
                     <tbody>
                        <c:forEach var="mSBoard" items="${mSBoard}">
                           <tr>
                              <td><a
                                 href="/mBoardDetail?boardNum=${mSBoard.boardNum}&userId=${user.userId}">${mSBoard.boardNum }</a></td>
                              <td>${mSBoard.boardTitle}</td>
                              <td>${mSBoard.boardUserId}</td>
                              <td>${mSBoard.pName}</td>
                              <td>${mSBoard.boardDate}</td>
                              <td>${mSBoard.boardCount}</td>
                           </tr>
                        </c:forEach>
                     </tbody>
                  </table>
