...
<%@ include file="../include/mFooter.jsp" %>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form action="/lessonUpdate" method="post" name="lessonpost">
    <div class="content">
    ...
    <h3 class="card-title">상세보기</h3>
     	...
     	<div class="card-body">
     	<input type="hidden" name="lectureNum" value="${mlessonUpdate.lectureNum}"/>
     	<div class="form-group">
     	<label>강의 명</label>
     	 <input type="text" name="lectureName"class="form-control" value="${mlessonUpdate.lectureName}"/>
     	
     	<label>강의 기간</label>
     	 <input type="date" name="lectureDateStart"class="form-control" value="${mlessonUpdate.lectureDateStart}" max="9999-12-31"/>
     	 <input type="date" name="lectureDateEnd" class="form-control" value="${mlessonUpdate.lectureDateEnd}" max="9999-12-31"/>
     	
     	<label>담당 강사</label>
     	<input type="hidden" name="uId" value="${mlessonUpdate.uId}">
     	...
     	class="form-control">${mlessonUpdate.lectureContent}</textarea>
    </div>
    <!-- /.content -->
  ...
  <div class="box-footer">
  	...
  	<button class="btn btn-warning mBtn" name="updatepost">수정</button>
