    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12">
          <form action = "/boardEdit" method = "post" name = "frm">
            <div class="card card-primary card-outline">
              ...
              <div class="form-group">
                  <input class="form-control" type = "hidden" name = "boardNum" value="${board.boardNum }" readonly>
                  <input class="form-control" type = "hidden" name = "idCheck" value="${param.userId }" >
                </div>
                <div class="form-group">
                  <input class="form-control" type = "text" name = "boardUserId" value="${board.boardUserId }" readonly>
                </div>
                <div class="form-group">
                  <input class="form-control" type = "text" name = "boardTitle" value="${board.boardTitle }">
                </div>
				<div class="form-group">
				<input class="form-control" type = "text" name = "boardId" value="${board.pName }" readonly>
				</div>
				
									
                <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height:800px; resize: none;" maxlength="100" name = "boardContent" >
                    ${board.boardContent }
                    </textarea>
                </div>
                <div class="form-group">
              ...
              <div class="card-footer">
                <div class="float-right">
                  ...
                  <button type="submit" class="btn btn-primary" onclick="return registerCheck()"><i class="far fa-envelope"></i>저장</button>
                </div>
