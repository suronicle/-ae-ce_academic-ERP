	...
	<div class="login-box">
		...
		<div class="card">
			<div class="card-body login-card-body">
				<p class="login-box-msg">중복체크 할 이메일을 입력해주세요.</p>

				<form action="/emailCheck" method="post" name="frm">
					...
					<div class="col-4" style="display: inline-block">
						<input type="submit" class="btn btn-warning btn-block"
							name="emailCheckbtn" value="중복체크" onclick="return emailCheckCheck()">
					</div>
					<div class="col-4" style="display: inline-block; float: right;">
						<button type="submit" class="btn btn-primary btn-block"
							name="emailOkbtn" onclick="emailOk()">사용하기</button>
					</div>
					<!-- /.col -->
				</form>
